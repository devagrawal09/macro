...
export class Sdk extends HeyApiClient {
     ...
     */
    public taskEventsHandler<ThrowOnError extends boolean = false>(options: Options<TaskEventsHandlerData, ThrowOnError, TaskEventsHandlerResponse>): Promise<ServerSentEventsResult<TaskEventsHandlerResponses>> {
        return (options.client ?? this.client).sse.get<TaskEventsHandlerResponses, TaskEventsHandlerErrors, ThrowOnError>({ url: '/projects/{id}/task_events', ...options });
    }
